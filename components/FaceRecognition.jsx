...
// // import "sonner/dist/index.css"; // ensure your styles are loaded
...
//             setAttendance((prev) => {
//               if (!prev.includes(name) && name !== "Unable to detect") {
//                 toast(`${name}'s attendance taken.`, {
//                   action: { label: "Close", onClick: () => {} },
//                 });
//                 // toast.success(`${name} marked attendance!`);
//                 test(name, section, confidence); // server call
//                 return [...prev, name];
//               }
//               return prev;
//             });
...
//   return (
//     <div style={{ display: "flex", maxWidth: 1200, margin: "24px auto" }}>
